    ...
    <>
      <SideMenuContainer id='SideMenuContainer'>
        ...
        <SideMenuLanguage className='SideMenuLanguage'>
          <Tooltip label="Ingles" hasArrow bg='teal.300' color='gray.900' placement='right' borderRadius='5px' p='5px'>
            <MenuLanguage className='MenuLanguage'>
              <FontAwesomeIcon icon={faE} size='1x'/>
              <FontAwesomeIcon icon={faN} size='1x'/>
            </MenuLanguage>
          </Tooltip>
          <Tooltip label='Español' hasArrow bg='teal.300' color='gray.900' placement='right' borderRadius='5px' p='5px'>
            <MenuLanguage className='MenuLanguage'>
              <FontAwesomeIcon icon={faE} size='1x'/>
        ...
        <SideMenuOption className='SideMenuOption'>
          <Tooltip label='Certificados' hasArrow bg='teal.300' color='gray.900' placement='right' borderRadius='5px' p='5px'>
          ...
          <Tooltip label='Proyectos' hasArrow bg='teal.300' color='gray.900' placement='right' borderRadius='5px' p='5px'>
            <MenuOption className='MenuOption'>
              <Link to="/projects">
