...
const SideMenu = () => {
  const { isOpen: openSlide, onToggle } = useDisclosure()
  const githubPath = () => {
    ...
    <>
      <SideMenuContainer id='SideMenuContainer'>
        ...
        <SideMenuLanguage className='SideMenuLanguage'>
          <Tooltip label="Ingles" hasArrow bg='#5ad3bd' placement='right'>
            <MenuLanguage className='MenuLanguage'>
              <FontAwesomeIcon icon={faE} size='1x'/>
              <FontAwesomeIcon icon={faN} size='1x'/>
            </MenuLanguage>
          </Tooltip>
          <Tooltip label='Español' hasArrow bg='#5ad3bd' placement='right'>
            <MenuLanguage className='MenuLanguage'>
              <FontAwesomeIcon icon={faE} size='1x'/>
        ...
        <SideMenuOption className='SideMenuOption'>
          <Tooltip label='Certificados' hasArrow bg='#5ad3bd' placement='right'>
            <MenuOption className='MenuOption'>
              <FontAwesomeIcon icon={faUserGraduate} size='2xl' onClick={onToggle}/>
              {/* <CertificatesComponent isOpen={openSlide} /> */}
            </MenuOption>
          </Tooltip>
          <Tooltip label='Proyectos' hasArrow bg='#5ad3bd' placement='right'>
            <MenuOption className='MenuOption'>
              <Link to="/projects">
        ...
        <SideMenuLink className='SideMenuLink'>
          <Tooltip label='GitHub' hasArrow bg='#5ad3bd' placement='right'> 
            <MenuLink onClick={githubPath} className='MenuLink'>
              <FontAwesomeIcon icon={faGithub} size='lg'/>
            </MenuLink>
          </Tooltip>
          <Tooltip label='LinkedIn' hasArrow bg='#5ad3bd' placement='right'>
            <MenuLink onClick={linkedinPath} className='MenuLink'>
              <FontAwesomeIcon icon={faLinkedin} size='lg'/>
            </MenuLink>
          </Tooltip>
          <Tooltip label='E-Mail' hasArrow bg='#5ad3bd' placement='right'>
