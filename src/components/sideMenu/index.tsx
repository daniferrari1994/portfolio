    ...
    <>
      <SideMenuContainer id='SideMenuContainer'>
        ...
        <SideMenuLanguage className='SideMenuLanguage'>
          <Tooltip label="Ingles" hasArrow bg='#5ad3bd' color='#222222' placement='right' borderRadius='5px' p='5px'>
            <MenuLanguage className='MenuLanguage'>
              <FontAwesomeIcon icon={faE} size='1x'/>
              <FontAwesomeIcon icon={faN} size='1x'/>
            </MenuLanguage>
          </Tooltip>
          <Tooltip label='Español' hasArrow bg='#5ad3bd' color='#222222' placement='right' borderRadius='5px' p='5px'>
            <MenuLanguage className='MenuLanguage'>
              <FontAwesomeIcon icon={faE} size='1x'/>
        ...
        <SideMenuOption className='SideMenuOption'>
          <Tooltip label='Certificados' hasArrow bg='#5ad3bd' color='#222222' placement='right' borderRadius='5px' p='5px'>
          ...
          <Tooltip label='Proyectos' hasArrow bg='#5ad3bd' color='#222222' placement='right' borderRadius='5px' p='5px'>
            <MenuOption className='MenuOption'>
              <Link to="/projects">
        ...
        <SideMenuLink className='SideMenuLink'>
          <Tooltip label='GitHub' hasArrow bg='#5ad3bd' color='#222222' placement='right' borderRadius='5px' p='5px'> 
            <MenuLink onClick={githubPath} className='MenuLink'>
              <FontAwesomeIcon icon={faGithub} size='lg'/>
            </MenuLink>
          </Tooltip>
          <Tooltip label='LinkedIn' hasArrow bg='#5ad3bd' color='#222222' placement='right' borderRadius='5px' p='5px'>
            <MenuLink onClick={linkedinPath} className='MenuLink'>
              <FontAwesomeIcon icon={faLinkedin} size='lg'/>
            </MenuLink>
          </Tooltip>
          <Tooltip label='E-Mail' hasArrow bg='#5ad3bd' color='#222222' placement='right' borderRadius='5px' p='5px'>
