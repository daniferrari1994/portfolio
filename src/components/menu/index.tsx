    ...
    <MenuContainer id='MenuContainer'>
      ...
      <MenuOptionContainer className='SideMenuOption'>
          <MenuOption className='MenuOption'>
            <Link to="/">
              <StyledLink isActive={location.pathname === '/'}>Home</StyledLink>
            </Link>
          </MenuOption>
          <MenuOption className='MenuOption'>
            <Link to="/resume">
              <StyledLink isActive={location.pathname === '/resume'}>Resume</StyledLink>
            </Link>
          </MenuOption>
          <MenuOption className='MenuOption'>
            <Link to="/projects">
              <StyledLink isActive={location.pathname === '/projects'}>Work</StyledLink>
            </Link>
          </MenuOption>
          <MenuOption className='MenuOption'>
            <Link to="/contact">
